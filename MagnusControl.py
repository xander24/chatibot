...
def camera1Recv(numDir,wd):
	...
	while True:
		...
		if ind == 2:
			...
			if cv2.waitKey(1) & 0xFF == ord('q'):
				break
		Img_Byt = sys.getsizeof(ImgDcd)
		#print(Img_Byt)
		endTime = time.time()
		elapsedTime = endTime-startTime
		#print("Tiempo de ciclo Nro 1 : ",elapsedTime)
		if tiempoAc < 1:
			tiempoAc = tiempoAc + elapsedTime
			numF = numF + 1

		if tiempoAc > 1:
			#print("Tiempo para todo el ciclo Nro1 de un segundo : ", tiempoAc)
			#print("Cantidad de frames obtenidos Nro1 : ",numF)
			numF = 0
			tiempoAc = 0
		count = count + 1

	fin_time = time.time()
	time_dur = fin_time - ini_time
	file = open(nombreDirVid1 + "vid.txt","w")
	file.write(str(fin_time))
...
def camera2Recv(numDir,wd):
	...
	xmlI = """<PTZData version="2.0" xmlns="http://www.hikvision.com/ver20/XMLSchema">
	<pan> -70 </pan>
	<tilt> 100 </tilt>
	<zoom> 0 </zoom>
	</PTZData>"""
	xmlD = """<PTZData version="2.0" xmlns="http://www.hikvision.com/ver20/XMLSchema">
	<pan> 70 </pan>
	<tilt> -100 </tilt>
	<zoom> 0 </zoom>
	</PTZData>"""
	xmlS = """<PTZData version="2.0" xmlns="http://www.hikvision.com/ver20/XMLSchema">
	<pan> 90 </pan>
	<tilt> 0 </tilt>
	<zoom> 0 </zoom>
	</PTZData>"""
	...
	print(requests.put('http://admin:TUMI12345@192.168.137.20:80/ISAPI/PTZCtrl/channels/1/continuous', data=xmlI, headers=headers).text)
	time.sleep(1)
	print(requests.put('http://admin:TUMI12345@192.168.137.20:80/ISAPI/PTZCtrl/channels/1/continuous', data=xmlS, headers=headers).text)
	time.sleep(1)
	print(requests.put('http://admin:TUMI12345@192.168.137.20:80/ISAPI/PTZCtrl/channels/1/continuous', data=xmlD, headers=headers).text)
	time.sleep(1)
	print(requests.put('http://admin:TUMI12345@192.168.137.20:80/ISAPI/PTZCtrl/channels/1/continuous', data=xmlS, headers=headers).text)
	...
	imgSav=wd+"\poke4.png"
	print("Se extraera imagen de la cámara PTZ")
	cap = cv2.VideoCapture("rtsp://admin:TUMI12345@192.168.137.20:554/Streaming/channels/2/")
	cap.set(3,640)
	cap.set(4,480)
	while(True):
		ret, frame=cap.read()
		cv2.imwrite(imgSav,frame)
		cv2.imwrite(nombreDirVid2 + str(count) + ".png",frame)
		count=count+1
...
"}")
        icon = QIcon()
        icon.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/16x16/cil-window-minimize.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/16x16/cil-window-maximize.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/16x16/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon_Start = QIcon()
        icon_Start.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-power-standby.png")
...
"}")
        icon_Send = QIcon()
        icon_Send.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-arrow-circle-right.png")
...
"}")
        iconRecIzq = QIcon()
        iconRecIzq.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-media-record.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconSecIzq = QIcon()
        iconSecIzq.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-camera.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconGenIzq = QIcon()
        iconGenIzq.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-settings.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconRecCen = QIcon()
        iconRecCen.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-media-record.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconGenCen = QIcon()
        iconGenCen.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-settings.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconRecDer = QIcon()
        iconRecDer.addFile(u"C:/Users/TB-4H/OneDrive/Desktop/Devel/icons/24x24/cil-media-record.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconSetDer = QIcon()
        iconSetDer.addFile(u"C:/Users/TUMI Robotics/Desktop/Devel/icons/24x24/cil-camera.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        iconGenDer = QIcon()
        iconGenDer.addFile(u"C:/Users/TUMI Robotics/Desktop/Devel/icons/24x24/cil-settings.png", QSize(), QIcon.Normal, QIcon.Off)
